// Minimal, self-contained SHA-256 (FIPS 180-4) over a byte array -> lowercase hex.
// Used only as an independent reference to confirm the *circuit* simulation in the
// viewer produces the correct digest. Not performance-critical.
(function (global) {
  "use strict";
  const K = [
